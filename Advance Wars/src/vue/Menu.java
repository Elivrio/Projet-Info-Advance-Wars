...
public class Menu extends JFrame {
  ...
  static {
    ...
    */
    basicTab[0] = new MyColor(Color.RED.getRGB()/*, 50*/, "Rouge");
    basicTab[1] = new MyColor(Color.GREEN.getRGB()/*, 50*/, "Vert");
    basicTab[2] = new MyColor(Color.BLUE.getRGB()/*, 50*/, "Bleu");
    basicTab[3] = new MyColor(Color.YELLOW.getRGB()/*, 50*/, "Jaune");
    basicTab[4] = new MyColor(Color.MAGENTA.getRGB()/*, 50*/, "Magenta");
    basicTab[5] = new MyColor(Color.CYAN.getRGB()/*, 50*/, "Cyan");
    basicTab[6] = new MyColor(Color.WHITE.getRGB()/*, 50*/, "Blanc");
    basicTab[7] = new MyColor(Color.BLACK.getRGB()/*, 50*/, "Noir");
    basicTab[8] = new MyColor(Color.GRAY.getRGB()/*, 50*/, "Gris");
    basicTab[9] = new MyColor(Color.PINK.getRGB()/*, 50*/, "Rose");
    basicTab[10] = new MyColor(Color.ORANGE.getRGB()/*, 50*/, "Orange");
    basicTab[11] = new MyColor(148, 33, 146/*, 50*/, "Violet");
    basicTab[12] = new MyColor(170, 121, 66/*, 50*/, "Brun");
  }
