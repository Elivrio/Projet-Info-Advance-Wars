...
public abstract class General extends AbstractUnite {
   ...
   * @param i   L'indice de l'unite dans le tableau du type d'unite.
   */
  public General (String n, int pM, Combat c, Deplacement d, int dis, int por, int vis, int ess, TypeUnite t, Joueur j, int x, int y, int i) {
    super(n, pM, c, d, dis, por, vis, ess, 30000, t, j, x, y, i);
  }
}
